...
public class TransactionDAO {
    ...
    public List<Transaction> getTransactionsByAccount(String accountNumber) {
        ...
        try (Connection connection = DatabaseConnection.getConnection();
             PreparedStatement statement = connection.prepareStatement(SELECT_BY_ACCOUNT_SQL)) {
    ...
    /**
     * Get recent transactions for an account with limit
     */
    public List<Transaction> getRecentTransactionsByAccount(String accountNumber, int limit) {
        List<Transaction> transactions = new ArrayList<>();

        try (Connection connection = DatabaseConnection.getConnection();
             PreparedStatement statement = connection.prepareStatement(SELECT_RECENT_BY_ACCOUNT_SQL)) {
    ...
    /**
     * Get transactions for account by type
     */
    public List<Transaction> getTransactionsByAccountAndType(String accountNumber, TransactionType type) {
        List<Transaction> transactions = new ArrayList<>();

        try (Connection connection = DatabaseConnection.getConnection();
             PreparedStatement statement = connection.prepareStatement(SELECT_BY_ACCOUNT_AND_TYPE_SQL)) {
    ...
    public double getAccountBalance(String accountNumber) {
        try (Connection connection = DatabaseConnection.getConnection();
             PreparedStatement statement = connection.prepareStatement(GET_ACCOUNT_BALANCE_SQL)) {
